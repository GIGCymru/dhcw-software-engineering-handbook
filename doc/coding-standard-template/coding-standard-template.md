...
This is a placeholder template for authoring new coding standards. Copy
this page as a starting point when creating a new standard, replacing
the placeholder text in each section.
...
software developers have discretion to deviate from this standard, but
