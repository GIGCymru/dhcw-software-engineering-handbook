...
| --- | --- | --- | --- | --- |
| 1 | You avoid placing business logic in the database | ☐ | *T-SQL coding standard, [7.1](general-good-practice.md#avoid-using-t-sql-to-execute-business-logic)* | This is a general rule. But there may be times when there are good reasons not to follow it. |
